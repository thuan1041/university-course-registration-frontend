        ...
        <Row style={{ minHeight: 50, backgroundColor: '#ffffff', border: '2px solid #E1EBF6', borderRadius: 6 }}>
            <Col span={5}>
                <Card style={{ height: '100%', borderRadius: 0, border: 'none', backgroundColor: '#4EB0FF', color: 'white' }}>
                    ...
                    <br></br> */}
                    <p>Xin chào!</p> <br></br>
                    <h5 style={{ fontSize: 16 }}>{userInfo.name}</h5>
                    <p>Giới tính: {(userInfo.gender) == true ? 'Nam' : "Nữ"}</p>
                    <p>MSSV: {userInfo.studentId}</p>
                    <p>Trạng thái: {(userInfo.status) == true ? 'Đang học' : "Đã tốt nghiệp"}</p>
                    <br></br>
