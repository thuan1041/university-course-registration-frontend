...
const RegisteredCourse = ({ allCoursesData, onCourseRowClick, getRegisteredCourseByStudentId }) => {
    ...
    const data = [
        {
            ...
            hocPhi: '$100',
            hanNop: '2024-06-15',
            thu: <CheckOutlined style={{ color: 'green' }} />,
            trangThaiDangKy: 'Đăng ký mới',
            ngayDangKy: '2024-05-01',
            trangThaiHP: 'Chấp nhận mở lớp',
        },
        {
            key: '2',
            maLopHP: 'LH002',
            ...
            hocPhi: '$90',
            hanNop: '2024-06-20',
            thu: <CloseOutlined style={{ color: 'red' }} />,
            trangThaiDangKy: 'Học lại',
            ngayDangKy: '2024-05-03',
            trangThaiHP: 'Đã khóa',
        },
        // Thêm dữ liệu giả cho các dòng còn lại tại đây
    ];
    ...
    //     dataIndex: 'trangThaiHP',
    // },
    // {
    //     title: 'Thao tác',
    //     dataIndex: 'thaoTac',
    //     render: (_, record) => (
    //       <Button style={{fontSize:12}} type="primary" onClick={() => handleCancel(record.maLopHP)}>
    //         Hủy học phần
    //       </Button>
    //     ),
    // },
